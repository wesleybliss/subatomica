...
function SheetHeader({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn('gap-1.5 projects-4 flex flex-col', className)}
            {...props}/>
    )
}
...
function SheetFooter({ className, ...props }: React.ComponentProps<'div'>) {
    return (
        <div
            ...
            className={cn('gap-2 projects-4 mt-auto flex flex-col', className)}
            {...props}/>
    )
}
